...
Поддерживаются 6 языков: русский, английский, испанский, португальский, турецкий, арабский. Перевод определяется автоматически по `navigator.language`, строки — в `src/game/i18n.ts`.
...
2. Прогоняет сценарий из `e2e/promo-screenshots.spec.ts`: меню → доска → совпадение → середина игры → победный экран — на каждом из 6 языков
