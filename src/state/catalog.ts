...
export const CATALOG: ShopItem[] = [
  ...
  { id: 'sea.tropic', axis: 'seaTheme', nameKey: 'seaTropic', price: 100, tint: 0xaef0d0 },
  { id: 'sea.dusk',   axis: 'seaTheme', nameKey: 'seaDusk',   price: 140, tint: 0x9a86c8 },
  { id: 'sea.ember',  axis: 'seaTheme', nameKey: 'seaEmber',  price: 160, tint: 0xffb38a },
  ...
  { id: 'back.jade',    axis: 'cardBack', nameKey: 'backJade',    price: 90,  tint: 0x7fd4a8 },
  { id: 'back.onyx',    axis: 'cardBack', nameKey: 'backOnyx',    price: 120, tint: 0x3a3f4a },
  ...
  { id: 'ui.crimson', axis: 'uiPalette', nameKey: 'uiCrimson', price: 150,
    palette: { 'navy': '#2a0e14', 'navy-soft': '#3d1620', 'blue': '#a32638', 'blue-mid': '#cf3a4e', 'gold': '#ffcf8a', 'gold-border': '#e8a24d', 'text-muted': '#e8b8b8' } },
  { id: 'ui.slate',   axis: 'uiPalette', nameKey: 'uiSlate',   price: 150,
    palette: { 'navy': '#141a22', 'navy-soft': '#1f2832', 'blue': '#3d566e', 'blue-mid': '#5878a0', 'gold': '#cdd8e8', 'gold-border': '#8aa0bc', 'text-muted': '#b0bccc' } },
  { id: 'ui.sand',    axis: 'uiPalette', nameKey: 'uiSand',    price: 180,
    palette: { 'navy': '#2a2114', 'navy-soft': '#3d3020', 'blue': '#b07a32', 'blue-mid': '#d8a24e', 'gold': '#ffe6a8', 'gold-border': '#e8c878', 'text-muted': '#e0d2b0' } },
];
